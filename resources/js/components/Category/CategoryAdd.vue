                            ...
                            <div class="col-md-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Enter infomation to add data</h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <!-- <center>
                                                                <img v-bind:src="sdata.category_image"  alt="" style="width:100px" @error="replaceByDefault" />
                                                            </center> -->
                                                            <div class="input-group input-group-merge">
                                                                <span class="input-group-text">
                                                                   <vue-feather type="edit" style="width:15px"></vue-feather>
                                               ...
                                               <div class="col-12">
                                                ...
                                                <div class="col-sm-9 offset-sm-3">
                                                    <button type="submit" class="btn btn-primary me-1 waves-effect waves-float waves-light">{{ processing ? "Please wait" : "Submit" }}</button>
    ...
    export default {
        ...
        methods:{
            ...
            submitdata(e)
            {
                ...
                axios.post('/api/category-store', formData, config)
                .then((res) => {
                    ...
                    this.messages = res.data.msg;
                          ...
                          {
                              this.sdata.category_name = "";
                              this.sdata.category_slug = "";
                              this.sdata.category_code = "";
                              this.sdata.category_image = "";
                              this.sdata.category_status = 1;
